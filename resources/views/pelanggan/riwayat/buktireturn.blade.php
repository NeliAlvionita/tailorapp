        ...
        <div class="row">
            <div class="row" style="margin-top:120px;">
                    <div class="section-heading wow fadeIn" id="top" data-wow-duration="2s" data-wow-delay="1s" >
                        <center><h4 style="margin-top:20px;"> Bukti Transfer Pengembalian Uang Muka </h4>
                        <img src="{{ asset('assets/images/heading-line-dec.png')}}" alt="">
                        <span><img src="{{ asset('assets/images/heading-line-dec.png')}}" alt=""></span></center>
                    </div><br><br>
                    <div class="card-body">
                        <center>
                            <img class="zoom w3-hover-opacity" src="/bukti_return/{{ $pemesanan->bukti_return }}" alt="" style="width:500px; box-shadow: 5px 5px 5px lightblue;">
                        </center>
                    </div>
                    <center>
                    <br><br>
