            ...
            <div class="row" style="margin-top: 120px;">
                <div class="col-lg-12">
                    <div class="section-heading wow fadeIn" id="top" data-wow-duration="2s" data-wow-delay="1s">
                        <center><h4>Update <em> Pesanan</em> </h4>
                    ...
                    <form action="/pelanggan/keranjang/{{$detailpemesanan->id_detailpemesanan}}" method="post" enctype="multipart/form-data"> 
                        ...
                        <div class="row ">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="nama_kategori" value="{{ $detailpemesanan->produk->kategori->nama_kategori}}">
                                </div>
                            </div>
                        </div><br>
                        ...
                        @if($detailpemesanan->produk->kategori->nama_kategori=='Seragam Laki-laki')
                        <div class="heading">
                            <h6>Atasan</h6>
                            <hr style="height:5px;color:black;background-color:black">
                        ...
                        <div class="row wow fadeIn" id="top" data-wow-duration="4s" data-wow-delay="0.5s">
                            <div class="col" >
                                <button type="submit" class="btn btn-dark btn-block"><i class="fas fa-shopping-cart"></i>  Update Keranjang</button>
                            </div>
                        </div>
                    </form><br><br>
